...
def run_simulations(params, n_sims=1000):
    ...
    for _ in range(n_sims):
        ...
        for i, (n_in_person, n_remote, utility) in enumerate(zip(ns_in_person, ns_remote, utilities)):
            rows.append({"meeting_num": i, "n_in_person": n_in_person, "ns_remote": n_remote, "utility": utility})
